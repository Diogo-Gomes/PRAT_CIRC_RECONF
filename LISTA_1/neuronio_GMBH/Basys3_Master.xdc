...
##Buttons
set_property PACKAGE_PIN U18 [get_ports select_out]						
	set_property IOSTANDARD LVCMOS33 [get_ports select_out]
set_property PACKAGE_PIN T18 [get_ports select_in]						
...
##Pmod Header lk
##Sch name = lk1
#set_property PACKAGE_PIN J1 [get_ports {lk[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[0]}]
##Sch name = lk2
#set_property PACKAGE_PIN L2 [get_ports {lk[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[1]}]
##Sch name = lk3
#set_property PACKAGE_PIN J2 [get_ports {lk[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[2]}]
##Sch name = lk4
#set_property PACKAGE_PIN G2 [get_ports {lk[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[3]}]
##Sch name = lk7
#set_property PACKAGE_PIN H1 [get_ports {lk[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[4]}]
##Sch name = lk8
#set_property PACKAGE_PIN K2 [get_ports {lk[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[5]}]
##Sch name = lk9
#set_property PACKAGE_PIN H2 [get_ports {lk[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[6]}]
##Sch name = lk10
#set_property PACKAGE_PIN G3 [get_ports {lk[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {lk[7]}]
